...
public class ProveedorDAO {
    ...
    public void insertarProveedor(String nombreEmpresa, String nombreContacto, String direccion, String telefono, String correoElectronico, String categoriaProducto) {
        try {
