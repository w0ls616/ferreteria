...
public class EmpleadoDAO {
    ...
    public static void insertarEmpleado(Connection connection, int idEmpleado, String nombre, String apellido, String genero, String correo, String dui, String direccion, String telefono) {
        try {
